/*
 * @Author: rkm
 * @Date: 2020-12-18 10:03:50
 * @LastEditTime: 2021-01-28 10:27:21
 * @FilePath: \miniprogram-http-formdata\formdata.js
 * @LastEditors: rkm
 */
const mimeMap = require('./mimeMap.js')

function FormData(mini) {
    let fileManager = mini.getFileSystemManager();
    let data = {};
    let files = [];
